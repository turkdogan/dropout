...
static void shuffleMatrixPair(Eigen::MatrixXf& mat1, Eigen::MatrixXf& mat2)
{
...
static void splitMatrixPair(const Eigen::MatrixXf& mat1, const Eigen::MatrixXf& mat2,
...
static void fill_random(Eigen::MatrixXf& mat)
{
...
static void fill_random_normal(Eigen::MatrixXf& mat,
...
static void fill_uniform(Eigen::MatrixXf& mat, float a)
{
	std::default_random_engine generator;
...
static Eigen::MatrixXf _dtanh(Eigen::MatrixXf& mat)
{
	return 1.0f - mat.array().pow(2.0f);
}

static Eigen::MatrixXf sigmoid(Eigen::MatrixXf& mat)
{
	return 1.0f / (1.0f + (-mat.array()).exp());
}

static Eigen::MatrixXf dsigmoid(Eigen::MatrixXf& mat)
{
...
static Eigen::MatrixXf getRandomMatrix(int rows, int cols) {
